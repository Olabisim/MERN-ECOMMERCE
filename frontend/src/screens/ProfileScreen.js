...
const ProfileScreen = ({location, history}) => {
    ...
    useEffect(() => {
        ...
        if(!userInfo) {
            ...
            if(!user.name) {
                // the profile means the id 
                // it doesn't take actual user id 
                // user/profile not actual user
                // meaning /profile not /id
    ...
    return (
        <Row>
            ...
            <Col md={9}>
                {
                    // if not loading order and array is undefined
                    // or array is empty then output the list
